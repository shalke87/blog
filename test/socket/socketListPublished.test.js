...
describe("Socket.IO + listPublished post action", () => {
  ...
  describe("Post List Published Action", () => {
    it("should reach the post:listPublished action success", (done) => {
      
      clientSocket.emit("post:listPublished", {}, (response) => {
        try {
          console.log("post:listPublished response:", response);
