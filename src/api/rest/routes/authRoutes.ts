...
import UpdateUsernameValidator from "../validators/authValidators/UpdateUsernameValidator.js";
import UpdatePasswordValidator from "../validators/authValidators/UpdatePasswordValidator.js";
...
router.patch("/updateUsername", authenticateJWT, UpdateUsernameValidator, AuthController.updateUsername);
router.patch("/updatePassword", authenticateJWT, UpdatePasswordValidator, AuthController.updatePassword);
